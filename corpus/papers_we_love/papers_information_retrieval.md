---
title: "经典论文导读: 信息检索与全文搜索 (Information Retrieval)"
author: "Papers We Love 计算机科学学术共同体"
date: "2024"
period: "现代计算机科学"
volume: "计算机科学传世经典论文集 (Papers We Love)"
category: "信息检索与全文搜索 (Information Retrieval)"
...
〔本篇为 Papers We Love 经典学术文献库关于“信息检索与全文搜索 (Information Retrieval)”领域收录的传世奠基论文全景导读与本地文献档案。〕
...
- **[Authoritative Sources In A Hyperlinked Environment](./raw/information_retrieval/authoritative-sources-in-a-hyperlinked-environment.pdf)** `(0.25 MB)`
- **[Graph Of Word And Tw Idf](./raw/information_retrieval/graph_of_word_and_tw_idf.pdf)** `(0.32 MB)`
- **[Okapi At Trec3](./raw/information_retrieval/okapi-at-trec3.pdf)** `(0.27 MB)`
- **[The Pagerank Citation Ranking Bringing Order To The Web](./raw/information_retrieval/the-pagerank-citation-ranking-bringing-order-to-the-web.pdf)** `(0.29 MB)`


---
_本地归档路径: `corpus/papers_we_love/raw/information_retrieval/`_
