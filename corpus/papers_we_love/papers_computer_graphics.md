---
title: "经典论文导读: Computer Graphics"
...
〔本篇为 Papers We Love 经典学术文献库关于“Computer Graphics”领域收录的传世奠基论文全景导读与本地文献档案。〕
...
- **[Digital Video Stabilization And Rolling Shutter Correction Using Gyroscopes](./raw/computer_graphics/digital_video_stabilization_and_rolling_shutter_correction_using_gyroscopes.pdf)** `(4.98 MB)`
- **[Imaging Vector Fields Using Line Integral Convolution](./raw/computer_graphics/imaging_vector_fields_using_line_integral_convolution.pdf)** `(1.44 MB)`
- **[Pushpull++](./raw/computer_graphics/pushpull++.pdf)** `(10.75 MB)`


---
_本地归档路径: `corpus/papers_we_love/raw/computer_graphics/`_
