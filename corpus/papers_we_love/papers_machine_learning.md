---
title: "经典论文导读: 机器学习与统计推断 (Machine Learning)"
author: "Papers We Love 计算机科学学术共同体"
date: "2024"
period: "现代计算机科学"
volume: "计算机科学传世经典论文集 (Papers We Love)"
category: "机器学习与统计推断 (Machine Learning)"
...
〔本篇为 Papers We Love 经典学术文献库关于“机器学习与统计推断 (Machine Learning)”领域收录的传世奠基论文全景导读与本地文献档案。〕
...
- **[General Self Similarity  An Overview](./raw/machine_learning/General-self-similarity--an-overview.pdf)** `(0.25 MB)`
- **[Understanding Deep Convolutional Networks](./raw/machine_learning/Understanding-Deep-Convolutional-Networks.pdf)** `(1.46 MB)`


---
_本地归档路径: `corpus/papers_we_love/raw/machine_learning/`_
