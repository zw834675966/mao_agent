---
title: "引用文献: GitHub - nusr/hacker-laws-zh: 💻📖对开发人员有用的定律、理论、原则和模式。(Laws, Theories, Principles and Patterns that developers will find useful.) · GitHub"
author: "外部学术与工程文献"
date: "2024"
period: "现代软件工程"
volume: "黑客定律外部引用文献集"
category: "外部参考文献"
source: "https://github.com/nusr/hacker-laws-zh"
tags:
  - "外部参考资料"
  - "黑客定律文献库"
---

〔本文档为黑客定律与工程哲学文库中《nusr/hacker-laws-zh (GitHub)》所引用的权威外部文献全文资料，由自动化采集管线持久化留存。〕

# 一、 文献基本信息

- **文献标题**: GitHub - nusr/hacker-laws-zh: 💻📖对开发人员有用的定律、理论、原则和模式。(Laws, Theories, Principles and Patterns that developers will find useful.) · GitHub
- **原文链接**: [https://github.com/nusr/hacker-laws-zh](https://github.com/nusr/hacker-laws-zh)
- **引用锚文本**: nusr/hacker-laws-zh (GitHub)
- **抓取状态**: success
...
PricingSearch/Sign inSign upAppearance settings
...
该定律仅适用于选项 按顺序排列 的情况，例如 ABCD。这隐含在以二为底的对数中，也就是说决策者本质上在进行 二分法查找。实验表明，如果选项不是按顺序排列的，那么所花费时间与选项个数将会呈线性增长关系。
...
About
💻📖对开发人员有用的定律、理论、原则和模式。(Laws, Theories, Principles and Patterns that developers will find useful.)
Topicschinesecodingcomputersciencelawsprinciples
ResourcesReadmeMIT licenseActivity
Stars12.5k stars
Watchers346 watching
Forks1.0k forksReport repository
Releases
Packages
Used by
Contributors
...
---
_本地归档时间: 2026-09-05 | 来源: https://github.com/nusr/hacker-laws-zh_
