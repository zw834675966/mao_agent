...
〔本篇为经典开源图解教程《Hello 算法》中关于“数组与链表 · 列表”的完整文献与图文解析。〕
...
---
_来源文献: [krahets/hello-algo (GitHub)](https://github.com/krahets/hello-algo) · 章节: chapter_array_and_linkedlist\list.md_
