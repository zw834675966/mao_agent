...
〔本篇为经典开源图解教程《Hello 算法》中关于“搜索算法 · 二分查找”的完整文献与图文解析。〕
...
---
_来源文献: [krahets/hello-algo (GitHub)](https://github.com/krahets/hello-algo) · 章节: chapter_searching\binary_search.md_
